...
'''
enctext = 'Lxwp{j}~uj}rxw|*)bx~)l{jltnm)}qn)lxmn7)]qn)ox{ln)r|)\][XWP)r}q)x~*'
...
'''
The encrypted message is 'Congratulations! You cracked the code. The force is STRONG with you!' the key was +9
'''
...
while done == False:
       ...
       if current_room == 3:
           ...
           if interact.lower() == "c" or interact.lower == "cabinets":
               if kitchen == 0:
                   ...
                   print("There was nothing in the cabinets.")
   ...
   time +=1   
if Remote == True:
   print("Good job boomer! You got to watch TV tonight.")
else:
   print("You lost lmao! You don't get to watch TV tonight. Uh oh stinky loser wowow")

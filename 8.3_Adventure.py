...
print("Find your way around the ship and try to regain your memory. Something bad happened here.")
print("There's a hole in the side of the ship. You have thirty minutes to escape the ship before it collapses as you slowly regain your memory..")
print()
print()
print()
print()
...
while done==False:
    ...
    if user_input.lower()=="n" and current_room==0:
        ...
        if x==0:
            print()
            print("A memory plays in your mind...")
            print()
            print()
            print(bcolors.GUARDIANS + "GANTHET:  CAN WE TRUST YOU TO WORK WELL WITH YOUR FELLOW CORPS MEMEBERS GARDENER?")
            print()
            print()
            print(bcolors.GUY + "GUY:  YEAH YEAH, KEEP YOUR WHITE WIG ON YOUR BLUE BOBBLEHEAD GANTHET")
            print()
            print()
            x+=1
        print()
    ...
    if user_input.lower()=="e" and current_room==1:
        ...
        if d==0:
            ...
            print()
            print()
            print("GUY:  THOSE BLUE WEIRDOS ALWAYS GIVE YOU THE EXCITING STUFF JORDAN.")
            print()
            print()
            print(bcolors.HAL + "HAL:  WE ALL GO ON THIS ONE GUY.")
            print()
            print()
    ...
    if user_input.lower()=="w" and current_room==1:
        ...
        if c==0:
            ...
            print()
            print()
            print(bcolors.GUY + "GUY:  JOHNNY BOY, HOW'S IT FEEL TO BE STUCK WITH ME ON BABBYSITTING DUTY")
            print()
            print()
            print(bcolors.JOHN + "JOHN:  I DO MY DUTY TO THE CORPS GUY. YOU SHOULD TOO.")
            print()
            print()
    ...
    if user_input.lower()=="n" and current_room==101:
        ...
        if e==0:
            ...
            print()
            print()
            print("GUY:   SO NEWBIES, EXCITED FOR YOUR FIRST MISSION?")
            print()
            print()
            print(bcolors.SIMON + "SIMON:   IT'S NOT OUR FIRST MISSION GUY.")
            print()
            print()
            print(bcolors.GUY + "YEAH SIMON, BUT IT'S YOUR FIRST MISSION WITH ME.")
            print()
            print()
            print(bcolors.JESSICA + "JESSICA:   IS THAT SUPPOSED TO BE A WARNING.")
            print()
            print()
    ...
    if user_input.lower()=="n" and current_room==-29:
        ...
        if j==0:
            ...
            print()
            print()
            print(bcolors.KYLE + "KYLE:   GUY, I WANT YOU TO TRY REALLY HARD TO BE GOOD TO SIMON AND JESSICA.")
            print()
            print()
            print(bcolors.GUY + "GUY:   AWW, YOU KNOW ME KYLE. ALWAYS STAYING OUT OF TROUBLE.")
            print()
            print()
    ...
    if user_input.lower()=="i" and current_room==1:
        ...
        print()
        print()
        print("GUY:   I TOLD YOU THERE WAS NO REASON TO ESCORT THIS SHIP.")
        print()
        print()
        print(bcolors.JOHN + "JOHN:   IF THE GUARDIANS WANT US ON THIS SHIP, THEN THAT'S WHERE WE'LL BE.")
        print()
        print()
        print(bcolors.JESSICA + "JESSICA:   I REALLY DON'T THINK I NEED YOU TWO TO WATCH US. SIMON AND I ARE PERFECTLY CAPABLE OF HANDLING OURSELVES.")
        print()
        print()
        ...
        print()
        print()
        print(bcolors.SIMON + "SIMON:   I BET HAL AND KYLE ARE HAVING A GREAT TIME FLOATING ON GUARD DUTY. THEY MIGHT ACTUALLY BE MORE BORED THAN US.")
        print()
        print()
    ...
    if user_input.lower()=="i" and current_room==101:
        ...
        print()
        print()
        print(bcolors.GUY + "GUY:   WE'VE LOST THE NEWBIES.")
        print()
        print()
        print(bcolors.JOHN + "JOHN:   WE'LL FIND THEM LATER. OUR FIRST PRIORITY IS PROTECTING THE KORUGIAN LEADERS.")
        print()
        print()
    ...
    if user_input.lower()=="i" and current_room==-29:
        ...
        if b==1:
            ...
            print()
            print()
            print(bcolors.KYLE + "KYLE:   THEY JUST KEEP COMING. WE CAN'T MAKE A DENT IN THEIR RANKS.")
            print()
            print()
            print(bcolors.HAL + "HAL:   I DON'T THINK OUR FIGHT'S GOING TO LAST MUCH LONGER.")
            print()
            print()
    ...
    if user_input.lower()=="i" and current_room==102:
        ...
        if k==1:
            ...
            print()
            print()
            print(bcolors.SIMON + "SIMON:   I CAN'T SEE." )
            print()
            print()
            print(bcolors.JESSICA + "JESSICA:   SIMON?")
            print()
            print()
    ...
    if user_input.lower()=="i" and current_room==-28:
        ...
        if n==1:
            ...
            print()
            print()
            print(bcolors.JOHN + "JOHN:   GUY? GUY?")
            print()
            print()
    ...
    if current_room==1 and v==1:
        ...
        print()
        print()
        print("You slowly remember why the ship is destroyed.")
        print()
        print()
        print(bcolors.GUY + "GUY:   JOHN, I HAVE AN IDEA.")
        print()
        print()
        print(bcolors.JOHN + "JOHN:   WE'VE LOST THE KORUGIANS. I'M WILLING TO TRY ANYTHING.")
        print()
        print()

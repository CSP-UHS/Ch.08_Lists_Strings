...
room = ["\033[1;31;48m" "You are in your bedroom. There is a box with an unknown object.", 2, None, None, None] # 3 IS MEANT FOR STAIRS
room_list.append(room)
room = ["\033[1;31;48m" "Bedroom 2, this room is silent and very dark, weirdly dark.", 2, None, None, None]
room_list.append(room)
room = ["\033[1;31;48m" "Bedroom 3, this room sounds sounds of a train, also known as your dad's snoring.",2, None, None, None]
room_list.append(room)
room = ["\033[1;31;48m" "Bedroom 4, this room has a fan which is on and there is someone sleeping in the bedroom.",2, None, None, None]
room_list.append(room)
room = ["\033[1;31;48m" "Bathroom, this room is what it says it is. don't bother going there because there is nothing of interest for you there.",2, None, None, None]
room_list.append(room)
room = ["\033[1;31;48m" "You have done it, this is the stairs to the ground floor. You are relieved and now have the ability to go and get the sacred ice juice.",2, None, None, None]
room_list.append(room)
...
while not done:
    ...
    #SEARCH
        ...
        print("You are searching in the area.")
        if len(room_list) == 1:

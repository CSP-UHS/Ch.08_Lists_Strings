...
print("If you don't complete your tasks within 50 moves, you'll be kicked out. "
...
while not done:
    if 10 >= sleep > 0:  # warns player about sleep getting low
        ...
        break
    if 25 >= moves > 0:  # warns player about moves getting low
        print("You only have", moves,"moves left!")
    elif moves <= 0:
        print("You ran out of moves and got kicked out for not helping your patients in time.")
        done = True
        break
    if roll:
        if current_room == 2 or current_room == 4 or current_room == 7:
    ...
    if direction.lower() == "n" or direction.lower() == "north":  # if user puts this in the move this direction
        ...
        if next_room is None:
            ...
            moves -= 1
            sleep -= 2
    elif direction.lower() == "q" or direction.lower() == "quit":  # ends the game
        print("You quit, hope you had fun!")
        done = True
    elif direction.lower() == "c" or direction.lower() == "clipboard":  # shows player what they need to complete
        print("Moves left:", moves)
        print("Energy left:", sleep)
        if not p1:
    ...
    elif direction.lower() == "a" or direction.lower() == "action":  # actions players can do in certain rooms
        moves -= 1
        sleep -= 2
        if current_room == 0:
        ...
        if current_room == 2:
            ...
            if room2.lower() == "y" or room2.lower() == "yes":
                print("You fully rest, but lose 10 moves.")  # player regains all sleep but loses 5 moves
                sleep = 25
                moves -= 9
            elif room2.lower() == "n" or room2.lower() == "no":
        ...
        if current_room == 3:
            if not p3:
                ...
                if room3.lower() == "y" or room3.lower() == "yes":  # will start quest for patient 3
                    ...
                    roll = True
                elif room3.lower() == "n" or room3.lower() == "no":
                ...
                print("There isn't much to do here.")
                moves += 1
                sleep += 2
        if current_room == 4:
            ...
            if egg == 54 or egg == 32 or egg == 7:  # if one of these numbers they get a special prize
                print("Congrats you found an easter egg in the game and your needs were fully restored. You also "
                      "gained 15 moves!")
                sleep = 25
                moves += 15
                ...
                if room5.lower() == "y" or room5.lower() == "yes":
                    ...
                    if kid <= 25:  # if the number is less than or is 25 this situation happens
                        ...
                        if temp.lower() == "y" or temp.lower() == "yes":
                            print("A doctor comes and helps out, the patient was having a heatstroke and you saved "
                                  "them!")
                            p1 = True
                        elif temp.lower() == "n" or temp.lower() == "no":
                            print("The patient was having a heatstroke and eventually dies since you couldn't help "
                                  "them. "
                                  "You get kicked out.")
                            done = True
                        else:
                        ...
                        elif temp2.lower() == "n" or temp2.lower() == "no":
                            print("You don't page a doctor because the patient's vitals are all good. You successfully "
                                  "checked their vitals, good job!")
                            p1 = True
                        else:
                            print("This isn't an option")
                            moves += 1
                            sleep += 2
                elif room5.lower() == "n" or room5.lower() == "no":
                    print("You decide to come back later.")
                    moves += 1
                    sleep += 2
                else:
        ...
        if current_room == 6:
            if not p2:
                ...
                if room6.lower() == "y" or room6.lower() == "yes":
                    if not radiation:
                        print("You need to get the radiation dosage from a doctor in the Emergency Room first! Come "
                              "back "
                              "once you have it.")
                    else:
                        print("You take patient two to the radiation therapy room, and have them lay down on the "
                              "E.B.R.T "
                              "table.")
                        cancer = input("This patient has lung cancer, should you ask them to hold their breath during "
                                       "radiation? "
                                       "(Y for yes, N for no)")
                        if cancer.lower() == "y" or cancer.lower() == "yes":
                            ...
                            p2 = True
                        elif cancer.lower() == "n" or cancer.lower() == "no":
                            print("The radiation wasn't successful since they didn't hold their breath during "
                                  "radiation. "
                            ...
                            moves += 1
                            sleep += 2
                elif room6.lower() == "n" or room6.lower() == "no":
                    print("You decide to come back later.")
                    moves += 1
                    sleep += 2
                else:
        ...
        if current_room == 8:
            if roll:
                ...
                if surgery == 43 or surgery == 3:  # if one of these then the patient dies
                    ...
                    print("Phew! You successfully did those surgical steps and patient three lives!")
                    p3 = True
                    roll = False
            if not roll:
                ...
                moves += 1
                sleep += 1
    if p1 is True and p2 is True and True is p3:  # if the player completes all the tasks for the patients they win
